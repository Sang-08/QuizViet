...
export default function StudentHistory() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-secondary-900 mb-2">Lịch sử</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary-600">Quiz đã làm</p>
                <p className="text-2xl font-bold text-secondary-900">{history.length}</p>
              </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary-600">Điểm trung bình</p>
                <p className="text-2xl font-bold text-secondary-900">{averageScore}%</p>
              </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary-600">Thời gian học</p>
                <p className="text-2xl font-bold text-secondary-900">{totalTimeSpent}m</p>
              </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary-600">Tỷ lệ đúng</p>
                <p className="text-2xl font-bold text-secondary-900">
                  {history.length > 0 
                    ? Math.round(history.reduce((sum, quiz) => sum + quiz.correctAnswers, 0) / 
                                history.reduce((sum, quiz) => sum + quiz.totalQuestions, 0) * 100)
                    : 0}%
                </p>
              </div>
            ...
            <div className="card-content">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                <div className="text-center p-3 bg-secondary-50 rounded-lg">
                  ...
                  <p className={`text-lg font-bold ${getScoreColor(quiz.score)}`}>
                    {quiz.score}%
                  </p>
