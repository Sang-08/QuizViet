...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4" style={{background:'linear-gradient(135deg, rgba(59,130,246,0.85) 0%, rgba(16,185,129,0.85) 100%)'}}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button type="button" variant="outline" onClick={handleResendOtp}>Gửi OTP</Button>
                </div>
              </div>
